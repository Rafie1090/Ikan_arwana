...
<body class="bg-slate-50 text-slate-800 antialiased">
    ...
    <!-- NAVBAR (Matching welcome.blade.php) -->
    <nav class="fixed w-full z-50 glass border-b border-white/20 transition-all duration-300" id="navbar">
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-slate-100 absolute w-full left-0 top-20 shadow-lg z-50">
