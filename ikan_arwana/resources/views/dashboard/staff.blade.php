...
<div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <a href="{{ route('staff.product.stock') }}" class="group bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-primary/30 transition">
            ...
            <h4 class="font-bold text-slate-900 mb-1">Kelola Stok Produk</h4>
            <h4 class="font-bold text-slate-900 mb-1">Monitoring Air</h4>
            <p class="text-sm text-slate-500">Pantau kualitas air kolam.</p>
        </a>
